...
// Liste des articles de blog (à mettre à jour manuellement ou via CMS)
const blogArticles = [
  {
...
function generateArticleHTML(article) {
  return `
    <article class="blog-card" data-animate="slide-up">
      ...
      <div class="blog-card-footer">
        <div class="blog-author">
          ...
          <div class="author-info">
            ...
            <div class="author-date">${article.dateFormatted}</div>
          </div>
        </div>
        
        <a href="${article.slug}" class="blog-read-more">
          Lire l'article →
        </a>
      </div>
    </article>
...
function loadLatestBlogArticles() {
  ...
  blogGrid.innerHTML = latestArticles.map(article => generateArticleHTML(article)).join('');
